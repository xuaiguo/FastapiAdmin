"""OceanBase Oracle 租户示例 Schema"""

from pydantic import BaseModel, ConfigDict, Field


class ObOracleDemoCreateSchema(BaseModel):
    """创建"""
...
class ObOracleDemoUpdateSchema(ObOracleDemoCreateSchema):
    """更新"""


class ObOracleDemoOutSchema(ObOracleDemoCreateSchema):
    """响应"""
    id: int
