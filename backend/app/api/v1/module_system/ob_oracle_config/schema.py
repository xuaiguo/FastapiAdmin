...
class ObOracleConfigCreateSchema(BaseModel):
    """新增 OceanBase Oracle 配置"""
...
class ObOracleConfigUpdateSchema(ObOracleConfigCreateSchema):
    """更新 OceanBase Oracle 配置"""


class ObOracleConfigOutSchema(ObOracleConfigCreateSchema, BaseSchema, UserBySchema):
    """响应模型（密码脱敏）"""
...
@dataclass
class ObOracleConfigQueryParam:
    """查询参数"""
