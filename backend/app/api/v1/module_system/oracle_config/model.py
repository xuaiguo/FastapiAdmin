...
class OracleConfigModel(ModelMixin):
    """Oracle 数据库连接配置表"""

    __tablename__: str = "sys_oracle_config"
    __table_args__: dict[str, str] = {"comment": "Oracle 数据库连接配置"}
    ...
    service_name: Mapped[str] = mapped_column(String(100), nullable=False, comment="Oracle Service Name")
    db_type: Mapped[str] = mapped_column(String(10), default="CDB", nullable=False, comment="数据库类型(CDB/PDB)")
    auth_mode: Mapped[str] = mapped_column(String(10), default="NORMAL", nullable=False, comment="连接身份(NORMAL/SYSDBA/SYSOPER)")
